...
REM --- Windows: выкидываем nvidia-* и torch* (torch ставим отдельно нужной CUDA сборкой) ---
REM --- Также убираем sympy==..., потому что torch на Windows обычно требует sympy==1.13.1 ---
...
REM --- На всякий случай: uvicorn (если его нет в requirements или установка падала раньше) ---
